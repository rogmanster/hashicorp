...
# rogmanster change to template | Set variable
export LOCAL_IPV4=$(curl -s ${local_ip_url})
...
curl https://raw.githubusercontent.com/rogmanster/hashicorp/master/vault-guides/vault-replication-demo/install-vault.sh | bash

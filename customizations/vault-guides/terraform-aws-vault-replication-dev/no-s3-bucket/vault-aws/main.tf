...
module "vault_lb_aws" {
  #rogmanster - customized to not deploy s3 bucket for LB
  #source = "github.com/hashicorp-modules/vault-lb-aws"
  source = "github.com/rogmanster/hashicorp/customizations/vault-guides/terraform-aws-vault-replication-dev/no-s3-bucket/vault-lb-aws/"

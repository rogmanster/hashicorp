...
data "template_file" "base_install" {
  template = "${file("/Users/rogman/Documents/GitHub/hashicorp/vault-guides/operations/provision-vault/templates/install-base.sh.tpl")}"
}

data "template_file" "consul_install" {
  template = "${file("/Users/rogman/Documents/GitHub/hashicorp/vault-guides/operations/provision-vault/templates/install-consul-systemd.sh.tpl")}"
...
data "template_file" "vault_install" {
  # rogmanster | changed file - replication
  template = "${file("/Users/rogman/Documents/GitHub/hashicorp/vault-guides/operations/provision-vault/templates/replication-demo-install-vault-systemd.sh.tpl")}"
